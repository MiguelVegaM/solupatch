...
import logoPrincipal from "../../assets/imgs/LOGO-PERMAMIX.png";
      ...
      {cotizacionSeleccionada ? (
        <div className="pdf__container">
          ...
          <div ref={pdfRef} className="pdf">
            <section className="">
              <div className="pdf__header pdf__header--permamix">
                <img
                  style={{
                    width: "660px",
                    marginLeft: "0px",
              ...
              <div className="pdf__header">
                ...
                <div className="pdf__header__title pdf__header__title__bacherey">
                  <div className="pdf__header__datos">
            ...
            <section className="cotizacion">
              ...
              >
                <thead className="cotizacion__title__thead--permamix cotizacion__title__thead">
                  <tr>
            ...
            <section className="footer footer--permamix">
